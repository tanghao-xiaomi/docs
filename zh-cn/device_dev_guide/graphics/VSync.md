...
openvela 的 Framebuffer 驱动框架提供了 `poll` 所需要的[接口](../../../../../../nuttx/blob/trunk-5.5/drivers/video/fb.c)，用于监控 Framebuffer 是否处于可写状态：
...
使用信号量进行同步，相当于对 Framebuffer 进行加锁操作，渲染器每次开始渲染时都需要拿到锁才能进行绘制，否则就会处于阻塞状态，代码请参见此 [链接](../../../../../../nuttx/blob/trunk-5.5/arch/arm/src/stm32/stm32_ltdc.c)。
