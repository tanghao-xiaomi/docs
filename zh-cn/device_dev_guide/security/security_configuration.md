...
| 12   | `CONFIG_TA_COMSST`                                 | 否       | `y``n` | 安全存储功能 TA                            | 根据设备特性决定是否开启 |
| 13   | `CONFIG_TA_HELLO_WORLD`                            | 否       | `y``n` | Hello World 示例 TA                        |                          |
...
| 3    | `CA_COMSST_API`          | 否       | `y``n` | 安全存储功能 CA 的 API                 |
| 4    | `CA_HELLO_WORLD`         | 否       | `y``n` | Hello World 示例 CA 的 API             |
