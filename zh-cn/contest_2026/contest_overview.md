...
3. **申领开发板**：申请开发板后，组委会会审核你的**作品方向与所选开发板是否匹配**；匹配通过后，按下方「赋能支持」缴纳 50 元押金即可领取开发板。提交作品者全额退还押金、开发板免费留存；未提交作品者需归还开发板，归还后押金全额退回。（纯快应用方向初赛用 openvela 模拟器即可、无需真机，真机可在决赛阶段再申领。）
