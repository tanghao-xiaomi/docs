...
- **硬件免费**：申领官方开发板（缴纳 50 元押金）。提交作品者全额退还押金、开发板免费留存；未提交作品者需归还开发板，归还后押金全额退回。押金通过**飞书转账**缴纳，转账对象为大赛交流群内的开发板运营人员。可选型号详见 [支持的硬件平台](./hardware_porting/supported_hardware.md)。纯快应用方向初赛阶段用 openvela 模拟器即可、无需真机，真机可在决赛阶段再申领。
