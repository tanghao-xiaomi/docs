...
- **硬件免费**：申领官方开发板（缴纳小额押金）。提交作品者全额退还押金、开发板免费留存；未提交作品者需归还开发板。可选型号详见 [支持的硬件平台](./hardware_porting/supported_hardware.md)。纯快应用方向初赛阶段用 openvela 模拟器即可、无需真机，真机可在决赛阶段再申领。
