...
- 联系[文档团队资料作者](./doc_reviewer.md)，讨论文档设计。
- 参考[文档写作模板](https://github.com/open-vela/docs/tree/dev/zh-cn/contribute/template)进行配套文档的写作。
...
- 如需文档团队翻译，请在中文文档完成评审测试定稿后提交翻译需求。提交翻译需求时请配套提供以下信息：
    ...
    - 新增术语请补充至[术语表](../../overview/glossary.md)。
    - 英文截图。
