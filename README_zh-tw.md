...
2. [下載 openvela 源碼](./zh-cn/quickstart/Download_Vela_sources_zh-cn.md)
3. [編譯 openvela 源碼](./zh-cn/quickstart/Build_Vela_from_sources_zh-cn.md)
4. [在模擬器上運行編譯產物](./zh-cn/quickstart/Run_Vela_on_Vela_Emulator_zh-cn.md)
...
- [計算器](../../../../open-vela/packages_demos/blob/dev/calculator/Readme.md)：一個基礎的 UI 與邏輯交互示例。
- [親戚計算器](../../../../open-vela/packages_demos/blob/dev/relation_calculator/Readme_zh-cn.md)：演示複雜的條件邏輯與算法實現。
- [打地鼠](../../../../open-vela/packages_demos/blob/dev/Whackmole/README_zh-cn.md)：演示遊戲循環、亂數生成和動畫效果。

查看完整的原生應用列表，請訪問[原生應用示例倉庫](../../../packages_demos/blob/dev/README_zh-cn.md)。

### 快應用（Quick Apps）

- [小米手環天氣預報應用](../../.././packages_fe_examples/blob/dev/weather/README.md)：提供簡潔直觀的未來七日天氣信息展示。
- [音樂播放器](../../.././packages_fe_examples/blob/dev/player/README.md)：演示一個基礎的音樂播放器，包含音樂的播放，音量調節，歌單查看。
- [日曆](../../.././packages_fe_examples/blob/dev/calendar/README.md)：演示一個基礎的日曆。
