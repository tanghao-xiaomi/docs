...
> **关于 `docs` 仓库的特别说明**：自 2026 年 5 月 13 日起，`docs` 仓库采用双许可方案。文档正文采用 CC BY-NC 4.0 许可证，代码示例、配置文件和脚本继续采用 Apache License 2.0 许可证。提交 Pull Request 即表示您同意按上述条款授权您的贡献。详情参阅 [LICENSING_zh-cn.md](./LICENSING_zh-cn.md)。
