...
- For the relevant implementation code, see [openvela Semaphore](../../../../../../../open-vela/nuttx/tree/trunk-5.4/sched/semaphore).
...
- The implementation code can be found at [openvela Mutex](../../../../../../../open-vela/nuttx/tree/trunk-5.4/libs/libc/misc/lib_mutex.c).
...
The implementation code can be found at [openvela Spinlock](../../../../../../../open-vela/nuttx/tree/trunk-5.4/include/nuttx/spinlock.h).
...
- For related interface code, see [openvela atomic](../../../../../../../open-vela/nuttx/tree/trunk-5.4/include/nuttx/atomic.h).
...
- For the interface code, see the [openvela irq interface](../../../../../../../open-vela/nuttx/tree/trunk-5.4/include/nuttx/irq.h).
...
For the implementation code, see [openvela sched_lock.c](../../../../../../../open-vela/nuttx/tree/trunk-5.4/sched/sched/sched_lock.c) and [openvela sched_unlock.c](../../../../../../../open-vela/nuttx/tree/trunk-5.4/sched/sched/sched_unlock.c).
...
For the implementation code, see [openvela pthread](../../../../../../../open-vela/nuttx/tree/trunk-5.4/libs/libc/pthread).
...
- For the implementation code, see the [openvela wqueue](../../../../../../../open-vela/nuttx/tree/trunk-5.4/sched/wqueue).
...
- For the implementation code, see the [openvela mqueue](../../../../../../../open-vela/nuttx/tree/trunk-5.4/sched/mqueue) source.
