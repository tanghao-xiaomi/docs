...
- For the implementation code, see the [openvela wqueue](../../../../open-vela/nuttx/tree/dev/sched/wqueue) source.
...
- For a detailed description of message queues, refer to the [Message Queues]().
