...
1.  **Set up the openvela development environment.**
    ...
    First, please follow the official documentation [Set up the development environment](../../en/quickstart/Set_up_the_development_environment.md) to complete the basic setup.
...
Please ensure you have the complete `openvela` source code ready locally, following the official documentation [Download Vela sources](../../en/quickstart/Download_Vela_sources.md).
...
-   **Application Layer (Examples)**: [nuttx-apps/examples/leds](../../../../../../../open-vela/nuttx-apps/tree/dev/examples/leds)
-   **Board Support Package (BSP)**: [nuttx/boards/arm/stm32/stm32f411-minimum](../../../../../../../open-vela/nuttx/tree/dev/boards/arm/stm32/stm32f411-minimum)
...
2.  **Select the target board.**
    ...
    3.  Press Enter to select **STM32F411CEU6 Minimum ARM Development Board** to compile firmware for the STM32F411CEU6 minimum system board:
...
1.  Return to the `openvela` root directory and run `menuconfig`.
...
After finishing, save the configuration and exit.
...
Please follow the instructions in [Chapter 4](#4-running-the-demo) to run the demo.
