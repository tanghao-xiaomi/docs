...
- UIKit: Contains high-level components and management suites. ([uikit](./../../../../../frameworks_graphics_uikit/blob/trunk/README.md))
...
- [Calculator](./../../../../../packages_demos/blob/trunk/calculator/Readme.md): A basic example of UI and logic interaction.
- [Relation Calculator](./../../../../../packages_demos/blob/trunk/relation_calculator/Readme.md): Demonstrates complex conditional logic and algorithm implementation.
- [Whack-a-Mole](./../../../../../packages_demos/blob/trunk/Whackmole/README.md): Demonstrates a game loop, random number generation, and animation effects.

To see the complete list of native apps, visit the [Native App Examples Repository](./../../../../../packages_demos/blob/trunk/README.md).

### Quick Apps

- [Xiaomi Band Weather App](./../../../../../packages_fe_examples/blob/trunk/weather/README.md): Provides a clean and intuitive display of the seven-day weather forecast.
- [Music Player](./../../../../../packages_fe_examples/blob/trunk/player/README.md): Demonstrates a basic music player, including music playback, volume control, and playlist viewing.
