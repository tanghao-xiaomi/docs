...
openvela supports a range of popular development boards. For a detailed list, see the [List of Supported Development Boards](./../../../../../docs/blob/trunk-5.2/en/dev_board/Development_Board.md).
