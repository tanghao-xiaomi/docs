...
The openvela community provides a ready-to-use [xTS Test Case Collection](../test_dev_guide/openvela_xts_test_cases.md) that covers standard test cases for system kernel, driver BSP, filesystem, WiFi, Bluetooth, audio/video and other fundamental capabilities. Commands can be copied directly into nsh for execution without writing tests from scratch.
